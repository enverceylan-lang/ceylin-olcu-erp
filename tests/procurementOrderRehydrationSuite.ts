...
const h=rehydrateCentralProcurementLine({supplierOrderId:"o",supplierOrderLineId:"ol",saleId:"s",saleItemId:"i",stockItemId:"st",supplierId:"sup",
...
assert.equal(h.order.status,"ORDERED");assert.equal(h.order.supplierOrderLineId,"ol");assert.equal(h.allocation.sourceType,"SUPPLIER_ORDER");
